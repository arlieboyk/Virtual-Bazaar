...
const SLIDES = Array.from(Array(SLIDE_COUNT).keys())
  return (
    ...
    <div className="embla__container">
        ...
        <div className="embla__slide"><Image src={'/products/b1.png'} alt='carousel-1' height={800} width={800} /></div>
        <div className="embla__slide"><Image src={'/products/b2.png'} alt='carousel-1' height={800} width={800} /></div>
        <div className="embla__slide"><Image src={'/products/b1.png'} alt='carousel-1' height={800} width={800} /></div>
